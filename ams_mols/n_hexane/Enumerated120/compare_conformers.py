...
pathname = '/home/bulo/Ravi/Molecules/set3/n_hexane/Confs1000/'
filename = os.path.join(pathname,'mol.xyz')
mol = Molecule(filename)
print ('nats: ',len(mol))

conformers = read_conformers (mol, pathname)
...
conformers_test = read_conformers (mol, os.getcwd(), method='ENUM')
print ('Number of enumerated conformers: ',len(conformers_test))
