...
class MoleculeOptimizer :
        ...
        convergence_settings['ams']       = {'Energy':1.e-5,'Gradients':1.e-3}# /Units.conversion_ratio('Bohr','Angstrom')}
        convergence_settings['ams_tight'] = {'Energy':1.e-7,'Gradients':1.e-5}# /Units.conversion_ratio('Bohr','Angstrom')}
        ...
        def optimize_geometries (self, geometries, level='ams', name='go') :
                """
                ...
                self.settings.input.ams.GeometryOptimization['Convergence'] = self.convergence_settings[level]
